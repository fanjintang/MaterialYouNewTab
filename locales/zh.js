...
const zh = {
    ...
    "todoImportFailed": "导入失败：无效的JSON文件",
    "todoDueOverdue": "已逾期",
    "todoDueToday": "今天到期",
    "todoNotificationTitle": "待办提醒",
    "todoContextMenuAdd": "添加到待办清单",
    "importText": "导入",
    "exportText": "导出",
    ...
    "aiAssistantInfo": "快速访问AI聊天机器人",

    // Quick Tools
    "quickToolsTitle": "快捷工具",
    "quickToolsInfo": "计算器、翻译、二维码",

    // Custom Widgets
    "customWidgetsTitle": "自定义小组件",
    "customWidgetsInfo": "倒计时、汇率、股票",

    // Date Reminders
    "dateRemindersTitle": "重要日期",
    "dateRemindersInfo": "跟踪生日和事件",

    // Shortcut Folders
    "shortcutFoldersText": "快捷方式文件夹",
    "shortcutFoldersInfo": "将快捷方式组织到文件夹中",
